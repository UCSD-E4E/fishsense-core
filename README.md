...
```toml
[dependencies]
fishsense-core = { git = "https://github.com/UCSD-E4E/fishsense-core", tag = "fishsense_core-v0.6.0" } # x-release-please-version
```
...
[tool.uv.sources]
fishsense-core = { git = "https://github.com/UCSD-E4E/fishsense-core", tag = "fishsense_core-v0.6.0", subdirectory = "python/fishsense_core" } # x-release-please-version
```
