...
```toml
[dependencies]
fishsense-core = { git = "https://github.com/UCSD-E4E/fishsense-core", tag = "v0.4.0" } # x-release-please-version
```
...
[tool.uv.sources]
fishsense-core = { git = "https://github.com/UCSD-E4E/fishsense-core", tag = "v0.4.0", subdirectory = "python/fishsense_core" } # x-release-please-version
```
